...
const lessons: SubjectEntry[] = [
  ...
  { id: 'hindi-lesson-4', label: 'मात्राएँ', sublabel: 'Matra Magic', path: '/hindi/lessons/4', emoji: 'ि', type: 'lesson' },
];
const games: SubjectEntry[] = [
  ...
  { id: 'hindi-game-4', label: 'शब्द मिलान', sublabel: 'Shabd Match', path: '/hindi/games/shabd-match', emoji: '🧠', type: 'game' },
];
