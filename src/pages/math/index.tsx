...
const lessons: SubjectEntry[] = [
  ...
  { id: 'math-lesson-4', label: 'पैटर्न', sublabel: 'Pattern Parade', path: '/math/lessons/4', emoji: '🔁', type: 'lesson' },
];
const games: SubjectEntry[] = [
  ...
  { id: 'math-game-5', label: 'आकार छाँटो', sublabel: 'Shape Sort', path: '/math/games/shape-sort', emoji: '🧩', type: 'game' },
];
